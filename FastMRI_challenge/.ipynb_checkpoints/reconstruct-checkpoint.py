...
def parse():
    ...
    parser.add_argument('--cascade', type=int, default=4, help='Number of cascades | Should be less than 12') ##important
    parser.add_argument('--chans', type=int, default=12, help='Number of channels for cascade U-Net')##important
    parser.add_argument('--sens_chans', type=int, default=8, help='Number of channels for sensitivity map U-Net')##important
